...
'''
starten af vores raspberry pi, viser teksten som vi beskriver her.
Slutningen siger at programmet er slut
'''
...
'''
Her sætter vi farver på de forskellige ting, dette vil sige at at vores time er grøn, sekunder er rød og blå er min. 
hvis det er et 12 timers ur så kommer der en hvid prik i toppen
'''
hour_color = (0, 255, 0)
...
'''
Her under laver vi event håndtering af det mini joystick. er den er pressed vil den fortælle det og når den er released fortæller den også
'''
...
'''
den første del gør at vi kan se vores binær ur i 8-bit og den sidste del gør så vi ser den i 4-bit
'''
...
'''
den viser urets tid og tidsformatten om det er en 12 timers eller 24 timers
'''
while True:
